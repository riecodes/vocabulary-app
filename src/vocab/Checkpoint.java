...
public class Checkpoint extends JFrame {
    ...
    public Checkpoint() {
        ...
        JLabel titleLabel = new JLabel("<html><center>English Language<br>Vocabulary in School</center></html>");
        ...
        buttonPanel.setBackground(new Color(252, 227, 252));
        
        // Create a rounded panel for the button
        ...
        startButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                SwingUtilities.invokeLater(() -> {
                    StartVocab startScreen = new StartVocab();
